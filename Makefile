...
server:
	go run main.go
mock:
	 mockgen -package mockdb -destination db/mock/store.go github.com/golandprojects/simplebank/db/sqlc Store

.PHONY: postgres12 createdb dropdb  migrateup migratedown migrateup1 migratedown1 sqlc test server